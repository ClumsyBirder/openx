...
| 平台 | ADB | HDC |
|------|-----|-----|
| Windows x64 | `adb/win/adb.exe` | `hdc/win/hdc.exe` |
| macOS Apple Silicon | `adb/darwin-arm64/adb` | `hdc/darwin-arm64/hdc` |
| macOS Intel | `adb/darwin-x64/adb` | `hdc/darwin-x64/hdc` |
| Linux x64（可选） | `adb/linux-x64/adb` | `hdc/linux-x64/hdc` |
